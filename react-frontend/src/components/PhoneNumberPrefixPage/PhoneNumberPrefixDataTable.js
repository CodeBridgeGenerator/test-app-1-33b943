...
<Column field="phonenumberprefix" header="Phonenumberprefix" body={pTemplate0} filter={selectedFilterFields.includes("phonenumberprefix")} hidden={selectedHideFields?.includes("phonenumberprefix")}  sortable style={{ minWidth: "8rem" }} />
