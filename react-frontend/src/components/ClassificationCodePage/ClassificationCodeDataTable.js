...
<Column field="classificationcode" header="Classificationcode" body={pTemplate0} filter={selectedFilterFields.includes("classificationcode")} hidden={selectedHideFields?.includes("classificationcode")}  sortable style={{ minWidth: "8rem" }} />
