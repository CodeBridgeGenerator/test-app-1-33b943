...
<Column field="currencycode" header="Currencycode" body={pTemplate0} filter={selectedFilterFields.includes("currencycode")} hidden={selectedHideFields?.includes("currencycode")}  sortable style={{ minWidth: "8rem" }} />
