...
<Column field="identifytype" header="Identifytype" body={pTemplate0} filter={selectedFilterFields.includes("identifytype")} hidden={selectedHideFields?.includes("identifytype")}  sortable style={{ minWidth: "8rem" }} />
