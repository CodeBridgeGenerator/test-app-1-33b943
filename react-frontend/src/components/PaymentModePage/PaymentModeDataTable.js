...
<Column field="paymentmode" header="Paymentmode" body={pTemplate0} filter={selectedFilterFields.includes("paymentmode")} hidden={selectedHideFields?.includes("paymentmode")}  sortable style={{ minWidth: "8rem" }} />
