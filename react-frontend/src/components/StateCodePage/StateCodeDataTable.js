...
<Column field="statecode" header="Statecode" body={pTemplate0} filter={selectedFilterFields.includes("statecode")} hidden={selectedHideFields?.includes("statecode")}  sortable style={{ minWidth: "8rem" }} />
