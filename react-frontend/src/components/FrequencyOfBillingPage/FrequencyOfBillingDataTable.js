...
<Column field="frequencyofbilling" header="Frequencyofbilling" body={pTemplate0} filter={selectedFilterFields.includes("frequencyofbilling")} hidden={selectedHideFields?.includes("frequencyofbilling")}  sortable style={{ minWidth: "8rem" }} />
