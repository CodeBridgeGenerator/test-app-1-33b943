...
<Column field="taxtype" header="Taxtype" body={pTemplate0} filter={selectedFilterFields.includes("taxtype")} hidden={selectedHideFields?.includes("taxtype")}  sortable style={{ minWidth: "8rem" }} />
