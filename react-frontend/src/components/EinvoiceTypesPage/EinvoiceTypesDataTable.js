...
<Column field="einvoicetypes" header="Einvoicetypes" body={pTemplate0} filter={selectedFilterFields.includes("einvoicetypes")} hidden={selectedHideFields?.includes("einvoicetypes")}  sortable style={{ minWidth: "8rem" }} />
