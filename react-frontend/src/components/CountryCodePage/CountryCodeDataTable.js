...
<Column field="countrycode" header="Countrycode" body={pTemplate0} filter={selectedFilterFields.includes("countrycode")} hidden={selectedHideFields?.includes("countrycode")}  sortable style={{ minWidth: "8rem" }} />
